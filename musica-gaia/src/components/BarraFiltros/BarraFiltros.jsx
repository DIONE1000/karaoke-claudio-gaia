  ...
  return (
    <>
      ...
      <div className="relative group">
        <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-red-500 transition-colors" size={20} />
        <input
          type="text"
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {temFiltroAtivo && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-500 hover:text-red-400 transition-colors"
          >
